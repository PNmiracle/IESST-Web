...
<template>
  <main class="login-page">
    <section class="login-aside"><div class="login-brand-logo"><img src="/images/iesst-logo-primary-compact.png" alt="IESST 思研学术" /></div><div><span class="eyebrow">CONTENT MANAGEMENT</span><h1>让内容维护更清晰、更高效</h1><p>独立管理轮播图、SCI / EI 期刊和用户投稿记录。</p></div><a href="/">← 返回访客官网</a></section>
