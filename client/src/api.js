...
export const api = {
  ...
  downloadStudentOrderFile: (orderId, fileId) => download(`/api/student/orders/${orderId}/files/${fileId}/download`),
  ...
  adminSubmissionFiles: (id) => request(`/api/admin/submissions/${id}/files`, { admin: true }),
  downloadAdminSubmissionFile: (submissionId, fileId) => download(`/api/admin/submissions/${submissionId}/files/${fileId}/download`),
  ...
  setStudentEnabled: (id, enabled) => request(`/api/admin/students/${id}/enabled`, { admin: true, method: "PUT", body: JSON.stringify({ enabled }) }),
